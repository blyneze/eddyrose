...
export default function TimingsPage() {
  return (
    <PageLayout
      ...
      breadcrumbs={[{ label: "PARENTS", href: "/parents" }, { label: "TIMINGS", href: "/parents/timings" }]}
      sidebarLinks={SIDEBAR_LINKS}
      sidebarTitle="PARENTS"
    >
      <div className="space-y-12">
        <section>
          <h2 className="text-4xl font-black text-eddyrose-deep mb-8">Daily Schedule</h2>
          
          <div className="space-y-6">
            <div className="flex justify-between items-center py-4 border-b border-zinc-100">
               <span className="font-bold text-eddyrose-deep">School Starts</span>
            ...
            <div className="flex justify-between items-center py-4 border-b border-zinc-100">
               <span className="font-bold text-eddyrose-deep">School Ends (Nursery)</span>
               <span className="text-zinc-500">1:30 PM</span>
            </div>
            <div className="flex justify-between items-center py-4 border-b border-zinc-100">
               <span className="font-bold text-eddyrose-deep">School Ends (Primary)</span>
