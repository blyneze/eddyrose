...
export const metadata: Metadata = {
  ...
  description: "Stay updated with the latest news, events, and announcements from Eddyrose International Academy.",
};
...
const NEWS_DATA: NewsItem[] = [
  {
    ...
    excerpt: "We are pleased to announce that admission forms for Crèche, Nursery, and Primary classes are now available. Secure your child's placement today.",
    date: "August 15, 2025",
  ...
  },
  {
    ...
    excerpt: "Join us for a day of thrilling athletic displays, teamwork, and healthy competition as our students compete for the championship trophy.",
  ...
  },
  {
    ...
    excerpt: "To further boost early childhood literacy, we've launched a dedicated Phonics and Reading Hub equipped with modern interactive learning tools.",
  ...
  },
  {
    ...
    excerpt: "A vibrant showcase of Nigerian heritage featuring traditional dances, food exhibitions, and history presentations by our primary students.",
    date: "November 20, 2025",
    time: "10:00 AM",
    location: "Main Assembly Hall",
    image: "https://images.unsplash.com/photo-1605335914620-1e5b15ffdf6b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  }
];
      ...
      <section className="relative w-full pt-16 md:pt-24 pb-20 md:pb-32 bg-eddyrose-deep overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 max-w-2xl mx-auto text-lg leading-relaxed">
            Stay plugged into the Eddyrose community. Discover our latest stories, upcoming events, and important school announcements.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-zinc-50 border-b border-zinc-100 -mt-10 relative z-20 rounded-t-[3rem] shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="inline-flex items-center gap-2 mb-8">
            ...
            <h2 className="text-xl font-bold text-zinc-900 tracking-tight">Featured Update</h2>
          </div>
          ...
          <div className="bg-white rounded-3xl overflow-hidden border border-zinc-100 shadow-sm hover:shadow-lg transition-shadow group flex flex-col md:flex-row">
            <div className="md:w-1/2 relative min-h-[300px] overflow-hidden">
              ...
              <div className="absolute top-4 left-4 inline-flex items-center gap-1.5 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full shadow-sm">
                <div className={`w-2 h-2 rounded-full ${featured.type === 'event' ? 'bg-eddyrose-light' : 'bg-eddyrose-gold'}`} />
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-zinc-900 mb-4 leading-tight group-hover:text-eddyrose-light transition-colors">
                {featured.title}
              </h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {gridItems.map((item) => (
              <div key={item.id} className="flex flex-col bg-zinc-50 rounded-3xl overflow-hidden border border-zinc-100 hover:shadow-lg transition-all group duration-300">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-sm flex items-center gap-1.5">
                    <div className={`w-1.5 h-1.5 rounded-full ${item.type === 'event' ? 'bg-eddyrose-light' : 'bg-eddyrose-gold'}`} />
